...
def main():
    ...
    parser.add_argument("--burn", type=float, default=3, help="number of burn samples")
    parser.add_argument("--sample", type=int, default=200, help="number of samples")
    parser.add_argument("--cSig", nargs="+", type=float, help="boundary parameters for sigmoid")
    ...
    params_hmc = hamiltorch.sample(log_prob_func=getlogprobs(c=args.cSig, mean=mean, stddev=stddev), params_init=params_init, num_samples=args.sample,
